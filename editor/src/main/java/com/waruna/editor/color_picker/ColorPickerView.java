...
package com.waruna.editor.color_picker;
...
public class ColorPickerView extends View {
    ...
    private void initPaintTools() {
        ...
        hueAlphaTrackerPaint.setStyle(Paint.Style.STROKE);
    ...
    private void drawAlphaPanel(Canvas canvas) {
        ...
        alphaShader = new LinearGradient(rect.left, rect.top, rect.right, rect.top, color, acolor, Shader.TileMode.CLAMP);
